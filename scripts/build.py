...
L["en"] = {
    ...
    "og_title": "Lossic",
    "og_desc": "Your music, in your Drive, playing instantly — and the story of every piece one swipe away. Lossless, private, offline-ready.",
    "nav": ["Features", "How it works", "FAQ"],
    "support": "Support",
    "h1": 'Your music, playing instantly. <em>Its story, one swipe away.</em>',
    "sub": "Lossic streams ALAC and FLAC straight from your own Google Drive — no servers in between, no re-encoding. Tap a track and it plays; swipe right and it tells you about the performer and the piece.",
...
L["zh"] = {
    ...
    "og_title": "Lossic",
    "og_desc": "你的音樂在你的 Drive，一點即播——每首曲子的故事，一滑即得。無損、私密、可離線。",
    "nav": ["功能", "怎麼運作", "常見問題"],
    "support": "支援",
    "h1": '你的無損音樂，一點即播<br><em>它的故事，一滑即得</em>',
    "sub": "Lossic 直接從你自己的 Google Drive 串流 ALAC 與 FLAC——中間沒有伺服器、不重新編碼。點一首歌，它就開始播；往右一滑，它會告訴你演奏者與這首曲子的故事。",
...
L["ja"] = {
    ...
    "og_title": "Lossic",
    "og_desc": "あなたの音楽は、あなたの Drive に。タップで即再生、スワイプで曲の物語を。ロスレス、プライベート、オフライン対応。",
    "nav": ["機能", "仕組み", "よくある質問"],
    "support": "サポート",
    "h1": 'あなたの音楽を、一瞬で。<em>その物語も、ひとつのスワイプで</em>。',
    "sub": "Lossic は ALAC と FLAC をあなた自身の Google Drive から直接ストリーミングします。間にサーバーはなく、再エンコードもしません。タップすればすぐ鳴り、右にスワイプすれば演奏者とその曲の物語を語ってくれます。",
...
L["ko"] = {
    ...
    "og_title": "Lossic",
    "og_desc": "내 Drive의 음악, 탭하면 바로 재생 — 곡의 이야기는 스와이프 한 번에. 무손실, 프라이빗, 오프라인 지원.",
    "nav": ["기능", "작동 방식", "자주 묻는 질문"],
    "support": "지원",
    "h1": '내 음악은 즉시 재생. <em>그 이야기는 스와이프 한 번에</em>.',
    "sub": "Lossic은 ALAC과 FLAC을 내 Google Drive에서 직접 스트리밍합니다. 중간 서버도, 재인코딩도 없습니다. 탭하면 바로 소리가 나고, 오른쪽으로 스와이프하면 연주자와 이 곡의 이야기를 들려줍니다.",
