...
L["en"] = {
    ...
    "title": "Lossic — The lossless player for your Google Drive",
    "desc": "Lossic streams ALAC and FLAC straight from your own Google Drive. No servers in between, no re-encoding — playback starts in about a fifth of a second.",
    "og_title": "Lossic",
    "og_desc": "Your music, in your Drive, playing instantly. Lossless, private, offline-ready.",
    "nav": ["Features", "How it works", "FAQ"],
    "support": "Support",
    "h1": 'Your music. Your&nbsp;Drive. <em>Instant.</em>',
    "sub": "Lossic streams ALAC and FLAC straight from your own Google Drive — no servers in between, no re-encoding. Tap a track and it plays.",
    ...
    "features": [
        ...
        ("wave", "Lossless, bit-perfect",
         "ALAC and FLAC stream untouched, from CD quality up to 24-bit/192 kHz. A format badge tells you exactly what you're hearing."),
    ...
    "faq": [
        ...
        ("Which formats does it play?",
         "ALAC and FLAC as first-class citizens, plus AAC and MP3. High-resolution files up to 24-bit/192 kHz play with their format shown on the face of the player."),
        ("Does streaming re-encode my files?",
         "Never. Lossic streams the original bytes of your file with HTTP range requests. What your DAC receives is bit-for-bit what you stored."),
        ("How fast is “instant”?",
...
L["zh"] = {
    ...
    "features": [
        ...
        ("wave", "無損、位元完美",
         "ALAC 與 FLAC 原樣串流，從 CD 品質到 24-bit/192 kHz。播放器上的格式徽章告訴你此刻聽到的是什麼。"),
        ("lock", "隱私是架構，不是承諾",
    ...
    "faq": [
        ...
        ("支援哪些格式？",
         "ALAC 與 FLAC 是一等公民，另外支援 AAC 與 MP3。高解析檔案最高支援 24-bit/192 kHz，格式直接顯示在播放器上。"),
        ("串流會重新編碼我的檔案嗎？",
         "永遠不會。Lossic 用 HTTP range 請求串流你檔案的原始位元組。你的 DAC 收到的，和你存進去的一位元都不差。"),
        ("「秒開」到底多快？",
...
L["ja"] = {
    ...
    "title": "Lossic — Google Drive のためのロスレスプレイヤー",
    "desc": "Lossic は ALAC と FLAC をあなた自身の Google Drive から直接ストリーミング。間にサーバーなし、再エンコードなし——タップから約0.2秒で再生。",
    "og_title": "Lossic",
    "og_desc": "あなたの音楽は、あなたの Drive に。タップで即再生。ロスレス、プライベート、オフライン対応。",
    "nav": ["機能", "仕組み", "よくある質問"],
    "support": "サポート",
    "h1": 'あなたの音楽を、あなたの Drive から、<em>一瞬で</em>。',
    "sub": "Lossic は ALAC と FLAC をあなた自身の Google Drive から直接ストリーミングします。間にサーバーはなく、再エンコードもしません。タップすれば、すぐ鳴ります。",
    ...
    "features": [
        ...
        ("wave", "ロスレス、ビットパーフェクト",
         "ALAC と FLAC を一切加工せずストリーミング。CD 品質から 24bit/192kHz まで。いま鳴っているフォーマットはバッジで確認できます。"),
    ...
    "faq": [
        ...
        ("対応フォーマットは？",
         "ALAC と FLAC を第一級として、AAC と MP3 にも対応。ハイレゾは 24bit/192kHz まで、フォーマットはプレイヤーに表示されます。"),
        ("ストリーミングで再エンコードされますか？",
         "決してされません。HTTP レンジリクエストでファイルの元のバイトをそのまま送ります。DAC に届くのは、保存したものとビット単位で同じです。"),
        ("「一瞬」とは、どれくらい？",
...
L["ko"] = {
    ...
    "og_title": "Lossic",
    "og_desc": "내 Drive의 음악, 탭하면 바로 재생. 무손실, 프라이빗, 오프라인 지원.",
    "nav": ["기능", "작동 방식", "자주 묻는 질문"],
    "support": "지원",
    "h1": '내 음악, 내 Drive에서, <em>즉시 재생</em>.',
    "sub": "Lossic은 ALAC과 FLAC을 내 Google Drive에서 직접 스트리밍합니다. 중간 서버도, 재인코딩도 없습니다. 탭하면 바로 소리가 납니다.",
